          ...
          - group "Your Personal Details" [ref=e80]:
            ...
            - generic [ref=e90]:
              ...
              - textbox "* E-Mail" [ref=e93]:
                - /placeholder: E-Mail
                - text: veniKa1782226520346@open.com
            - generic [ref=e94]:
...
> 74  |           await this.passWd.fill('');
      |                             ^ Error: locator.fill: Test timeout of 60000ms exceeded.
  75  |           await this.passWd.fill(pwd);
  76  |           await this.passConfirm.fill('');
  77  |           await this.passConfirm.fill(pwd);
  78  | 
  79  |           if(subscribe==='yes'){
  80  |             this.subscribeY.check();
  81  |           }else{
  82  |             this.subscribeN.check();
  83  |           }
  84  | 
  85  |           await this.privPolicy.check();
  86  |           await this.continueBtn.click();
  87  | 
  88  |           await this.regSuccessMesge.isVisible();
  89  | 
  90  |           let str = await this.regSuccessMesge.innerText();
  91  | 
  92  |           if(str==='Your Account Has Been Created!'){
  93  |             console.log('Registration--SUCCESS');
  94  |             return true;
  95  |           }else{
  96  |             console.log('Registration--FAILURE');
  97  |             return false;
  98  |           }
  99  | 
  100 | 
