...
Call log:
  - waiting for getByRole('textbox', { name: 'Password Confirm', exact: true })
        ...
        - generic [ref=e79]:
          - group "Your Personal Details" [ref=e80]:
            ...
            - generic [ref=e90]:
              ...
              - textbox "* E-Mail" [ref=e93]:
                - /placeholder: E-Mail
                - text: veniKa1782233440918@open.com
            - generic [ref=e94]:
          ...
          - group "Your Password" [ref=e98]:
            ...
            - generic [ref=e100]:
              ...
              - textbox "* Password" [active] [ref=e103]:
...
```ts
  ...
  74  |           console.log("Telephone:", tel);
  75  |           await this.telPh.fill(tel);
  76  |           console.log("Telephone filled");
  77  |           //await this.page.pause();
  78  |           console.log("Password:", pwd);
  79  |           await this.passWd.fill(pwd);
  80  |           console.log("Password filled");
  81  |           //await this.page.pause();
> 82  |           await this.passConfirm.fill(pwd);
      |                                  ^ Error: locator.fill: Test timeout of 6000ms exceeded.
  83  |           console.log("Confirm Password filled");
  84  | 
  85  |           if(subscribe==='yes'){
  86  |             this.subscribeY.check();
  87  |           }else{
  88  |             this.subscribeN.check();
  89  |           }
  90  | 
  91  |           await this.privPolicy.check();
  92  |           await this.continueBtn.click();
  93  | 
  94  |           await this.regSuccessMesge.isVisible();
  95  | 
  96  |           let str = await this.regSuccessMesge.innerText();
  97  | 
  98  |           if(str==='Your Account Has Been Created!'){
  99  |             console.log('Registration--SUCCESS');
  100 |             return true;
  101 |           }else{
  102 |             console.log('Registration--FAILURE');
  103 |             return false;
  104 |           }
  105 | 
  106 | 
